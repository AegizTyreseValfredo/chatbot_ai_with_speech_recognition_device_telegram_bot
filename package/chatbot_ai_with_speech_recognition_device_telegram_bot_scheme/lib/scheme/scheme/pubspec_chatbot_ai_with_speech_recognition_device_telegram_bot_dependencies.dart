...
class PubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies extends JsonScheme {
  ...
  static PubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies create({
    ...
    Map pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies_data_create_json = {
      "@type": special_type,
      "flutter": (flutter != null) ? flutter.toJson() : null,
      "cupertino_icons": cupertino_icons,
    };

    pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies_data_create_json
        .removeWhere((key, value) => value == null);
    PubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies
        pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies_data_create =
        PubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies(
            pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies_data_create_json);

    return pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependencies_data_create;
  }
}
