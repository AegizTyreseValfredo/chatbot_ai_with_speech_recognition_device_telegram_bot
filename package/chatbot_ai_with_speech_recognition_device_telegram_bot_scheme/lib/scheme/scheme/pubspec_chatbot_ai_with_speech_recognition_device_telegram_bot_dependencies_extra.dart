...
class PubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra extends JsonScheme {
  ...
  static PubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra create({
    ...
    Map pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra_data_create_json = {
      "@type": special_type,
      "sdk": sdk,
    };

    pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra_data_create_json
        .removeWhere((key, value) => value == null);
    PubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra
        pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra_data_create =
        PubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra(
            pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra_data_create_json);

    return pubspecChatbotAiWithSpeechRecognitionDeviceTelegramBotDependenciesExtra_data_create;
  }
}
